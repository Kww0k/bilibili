...
<template>
  <div id="card" class="card" :style="{height: cardHeight + 'px'}">
    <div>
      <div @click="router.push(`/${id}`)" class="card-img" :style="{height : imgHeight + 'px', backgroundImage: `url(${previewUrl})`}">
      </div>
      <div id="info" class="card-info">
        <div class="card-info-right" @click="router.push(`/${id}`)">
          ...
          <div class="card-info-bottom">
            ...
            <span @click="router.push(`/${id}`)" class="card-info-bottom-author">{{ createBy }} · {{ createTime }}</span>
          </div>
        </div>
      </div>
    </div>
