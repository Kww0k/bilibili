...
const placeholderList = ['勇敢滴少年啊，快去创作热评～',
  '评论千万条，等你发一条',
  '你渴望拥有力量吗？评论让力量更强大',
  '下面我简单喵两句', '这里是评论区，不是无人区;-)',
  '这里需要一条查重率0%的评论',
  '轻轻敲醒沉睡的心灵，让我看看你的点评',
  '天青色等烟雨，评论区在等你',
  '哎呦，不错哦，发条评论吧',
  ...
  '新的风暴已经出现，你的妙评何时再现',
  '与其赞同别人的话语，不如自己畅所欲言。',
  '尊重是评论打动人心的入场券', '宫廷玉液酒，评论走一走',
  '只是一直在等你而已，才不是想被评论呢～']

watch(commitChoose, () => {
  placeholderText.value = placeholderList[Math.floor(Math.random() * placeholderList.length)];
});
...
onMounted(() => {
  ...
  request.get("/file/web/file/getFileById/" + 103).then((res) => {
...
<template>
  ...
  <div :style="{ width: playWindowWidth.toString() + 'px', height : playWindowHeight.toString() + 'px'}" id="playWindow"
    ...
    <div id="fullback" class="fullback">
            ...
            <div>
              ...
              <div @mouseenter="processHover = true" @mouseleave="processHover = false"
                ...
                <div @click="changeProcess" id="progress" :style="{ width : progressWidth.toString() + 'px' }"
                     class="progress">
                  <div style="width: auto; height: 100%;display: flex; justify-content: space-between;">
                    <div id="now" :style="{ width : nowWight.toString() + 'px' }" class="now">
                      <div v-if="processHover" style="width: 20px; height: 20px; margin-top: -8px"
                           :style="{marginLeft: nowWight.toString() + 'px'}">
                            ...
                            <g transform="matrix(1,0,0,1,8.890999794006348,8.406000137329102)" opacity="1"
                              ...
                              <g opacity="1" transform="matrix(1,0,0,1,0.09099999815225601,1.1009999513626099)">
                                <path fill="rgb(255,255,255)" fill-opacity="1"
                                      d=" M7,-3 C7,-3 7,3 7,3 C7,4.379749774932861 5.879749774932861,5.5 4.5,5.5 C4.5,5.5 -4.5,5.5 -4.5,5.5 C-5.879749774932861,5.5 -7,4.379749774932861 -7,3 C-7,3 -7,-3 -7,-3 C-7,-4.379749774932861 -5.879749774932861,-5.5 -4.5,-5.5 C-4.5,-5.5 4.5,-5.5 4.5,-5.5 C5.879749774932861,-5.5 7,-4.379749774932861 7,-3z"></path>
                                <path stroke-linecap="butt" stroke-linejoin="miter" fill-opacity="0"
                                      stroke-miterlimit="4" stroke="rgb(51,51,51)" stroke-opacity="1" stroke-width="1.5"
                                      d=" M7,-3 C7,-3 7,3 7,3 C7,4.379749774932861 5.879749774932861,5.5 4.5,5.5 C4.5,5.5 -4.5,5.5 -4.5,5.5 C-5.879749774932861,5.5 -7,4.379749774932861 -7,3 C-7,3 -7,-3 -7,-3 C-7,-4.379749774932861 -5.879749774932861,-5.5 -4.5,-5.5 C-4.5,-5.5 4.5,-5.5 4.5,-5.5 C5.879749774932861,-5.5 7,-4.379749774932861 7,-3z"></path>
                              </g>
                            </g>
              ...
              <div @mouseenter="processHover = true" @mouseleave="processHover = false" style="height: 3px; width: 100%"
      ...
      <div style="border-bottom: 1px solid #E3E5E7;" :style="{width: commitDanmuWidth.toString() + 'px'}">
        ...
        <div class="video-tag">
          <div style="float: left;margin: 0 12px 8px 0;height: 32px;">
              <span style="height: 100%;line-height: 32px;border-radius: 16px;font-size: 14px;background-color: #F1F2F3; padding: 0 12px;box-sizing: border-box;transition: all .3s;display: inline-flex;align-items: center;cursor: pointer;">
                  <svg style="margin-right: 4px;width: 17px; height: 17px" data-v-606abc4e="" width="12" height="11"
                       viewBox="0 0 14 12" xmlns="http://www.w3.org/2000/svg" class="tag-icon newchannel-tag-icon"><path
                      fill-rule="evenodd" clip-rule="evenodd"
                      d="M4.25 2.75C4.25 1.23122 5.48122 0 7 0C8.51878 0 9.75 1.23122 9.75 2.75C9.75 4.26878 8.51878 5.5 7 5.5C5.48122 5.5 4.25 4.26878 4.25 2.75ZM0.5 9.25C0.5 7.73122 1.73122 6.5 3.25 6.5C4.76878 6.5 6 7.73122 6 9.25C6 10.7688 4.76878 12 3.25 12C1.73122 12 0.5 10.7688 0.5 9.25ZM10.75 6.5C9.23122 6.5 8 7.73122 8 9.25C8 10.7688 9.23122 12 10.75 12C12.2688 12 13.5 10.7688 13.5 9.25C13.5 7.73122 12.2688 6.5 10.75 6.5Z"
                      fill="currentColor"></path>
                  </svg>
                <span style="font-weight: 300">计算机</span>
              </span>
          </div>
        </div>
      </div>
      <div :style="{width: commitDanmuWidth.toString() + 'px'}">
        <div style="height: 90px;margin-top: 16px;text-align: right;
              background-size: cover;background-repeat: no-repeat;background-position: center"
             :style="{ backgroundImage: `url(${url2})`, width: commitDanmuWidth.toString() + 'px' }">
          <span style="width:38px;height: 22px;
          margin-right: 15px;color: rgba(0, 0, 0, 0.5);margin-top: 5px;
          border-radius: 5px; background-color: rgba(255,255,255,0.5); font-size: 12px">
            广告
          </span>
        </div>
        <div style="width: 100%; display: flex">
          ...
          <div class="choose-header">
            <div @click="commitChoose = false" style="cursor: pointer;font-size: 16px" :style="{color : commitChoose ? '#9499A0' : '#18191C'}">最热
            </div>
            <div style="height: 11px;border-left: solid 1px; margin: 7px 12px 0;"></div>
            <div @click="commitChoose = true" style="cursor: pointer;font-size: 16px" :style="{color : commitChoose ? '#18191C' : '#9499A0'}">最新
            </div>
          </div>
        </div>
        <div style="width: 100%">
          <div class="person-send-commit">
            <div style="display: flex;justify-content: center;align-items: center;width: 80px;height: 50px;">
              <el-avatar style="width: 48px; height: 48px;"
                         src="src/assets/img/defaultAvatar.jpg"/>
            </div>
            <div class="commit-input">
              <el-input v-model="text" style="line-height: 32px"
                        resize="none"
                  :rows="2"
                  type="textarea"
            ...
            <div class="do-sent-commit">
              <div class="send-text" data-v-757acbb5="">发布</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <aside style="margin-left: 20px"
      ...
      <div class="aside-header">
        <div class="aside-header-left">
          ...
          <span class="bui-dropdown-icon">
            <svg style="width: 100%; height: 100%" xmlns="http://www.w3.org/2000/svg" data-pointer="none"
                 viewBox="0 0 4 14"><path fill-rule="evenodd"
                                          d="M.5 2C.5 1.15 1.15.5 2 .5s1.5.65 1.5 1.5S2.85 3.5 2 3.5.5 2.85.5 2Zm0 5c0-.85.65-1.5 1.5-1.5s1.5.65 1.5 1.5S2.85 8.5 2 8.5.5 7.85.5 7Zm0 5c0-.85.65-1.5 1.5-1.5s1.5.65 1.5 1.5-.65 1.5-1.5 1.5S.5 12.85.5 12Z"></path></svg>
          </span>
        </div>
        <div class="aside-header-right">
          <svg style="transition: transform 0.3s ease" :style="{transform: isHovered ? 'rotate(180deg)' : ''}"
      ...
      <el-collapse-transition>
        <div v-if="isHovered" style="width: 100%; margin-top: 8px; margin-bottom: 5px"
      ...
      <div class="aside-body">
        ...
        <div style="width: 100%; margin-top: 18px">
          <div class="next-play">
            <div style="vertical-align: middle;line-height: 16px;height: 100%; align-items: center; display: flex">
              接下来播放
            </div>
            <div style="margin-right: 4px;font-size: 14px;
              vertical-align: middle;line-height: 16px;color: #9499A0; display: flex">
              <div style="margin-right: 4px;font-size: 14px;
                  vertical-align: middle;line-height: 16px;color: #9499A0;height: 100%; align-items: center; display: flex">
                自动播放
              </div>
              ...
              <el-col :span="12">
                <div class="card-body">
                  ...
                  <div style="display: inline-flex;align-items: center;color: #9499A0">
                    <svg class="play" style="width:18px;height:18px;margin-right: 4px"
                    ...
                    <svg class="dm" style="width:18px;height:18px;margin-right: 4px" xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 18 18" width="18" height="18">
                      <path
                          d="M9 3.7485375000000003C7.111335 3.7485375000000003 5.46225 3.84462 4.2981675 3.939015C3.4891575 4.0046175 2.8620825 4.6226400000000005 2.79 5.424405C2.7045525 6.37485 2.625 7.6282499999999995 2.625 8.9985C2.625 10.368825000000001 2.7045525 11.622225 2.79 12.5726625C2.8620825 13.374412500000002 3.4891575 13.992450000000002 4.2981675 14.058074999999999C5.46225 14.152425000000001 7.111335 14.2485 9 14.2485C10.888874999999999 14.2485 12.538050000000002 14.152425000000001 13.702200000000001 14.058037500000001C14.511074999999998 13.9924125 15.138000000000002 13.3746 15.210075 12.573037500000002C15.295499999999999 11.622975 15.375 10.3698375 15.375 8.9985C15.375 7.627237500000001 15.295499999999999 6.3740775 15.210075 5.4240375C15.138000000000002 4.622475 14.511074999999998 4.00464 13.702200000000001 3.9390374999999995C12.538050000000002 3.844635 10.888874999999999 3.7485375000000003 9 3.7485375000000003zM4.2072375 2.8176975C5.39424 2.7214425 7.074434999999999 2.6235375000000003 9 2.6235375000000003C10.925775 2.6235375000000003 12.606075 2.7214575 13.793099999999999 2.81772C15.141074999999999 2.92704 16.208849999999998 3.9695849999999995 16.330575 5.323297500000001C16.418174999999998 6.297675 16.5 7.585537500000001 16.5 8.9985C16.5 10.4115375 16.418174999999998 11.6994 16.330575 12.6738C16.208849999999998 14.027474999999999 15.141074999999999 15.0700125 13.793099999999999 15.1793625C12.606075 15.275625 10.925775 15.3735 9 15.3735C7.074434999999999 15.3735 5.39424 15.275625 4.2072375 15.179400000000001C2.859045 15.070049999999998 1.7912325 14.027212500000001 1.6695225000000002 12.673425C1.5818849999999998 11.69865 1.5 10.4106 1.5 8.9985C1.5 7.586475 1.5818849999999998 6.2984025 1.6695225000000002 5.3236725C1.7912325 3.96984 2.859045 2.9270175000000003 4.2072375 2.8176975z"
                          fill="currentColor"></path>
...
<style scoped>
.commit-input .el-textarea >>> .el-textarea__inner {
  background-color: #f1f2f3;
  box-shadow: 0 0 0 1px #dcdfe6;
}
.commit-input .el-textarea >>> .el-textarea__inner:hover {
  box-shadow: 0 0 0 1px #dcdfe6;
}
.commit-input {
  position: relative;
