      ...
      <div class="main-channel">
        ...
        <div style="flex-grow: 1; margin-left: -14px; display: flex; height: 66px; margin-top: 27px">
          ...
          <div class="channel-right">
            <a class="channel-link__right" href="//www.bilibili.com/read/home" style="letter-spacing:2px;"
               target="_blank">
              <svg t="1642646834655" class="icon side-icon" viewBox="0 0 1024 1024" version="1.1"
                   xmlns="http://www.w3.org/2000/svg" p-id="4061" width="200" height="200">
                <path
            ...
            <a class="channel-link__right" href="//live.bilibili.com" style="letter-spacing:2px;" target="_blank">
              <svg t="1642646710703" class="icon side-icon" viewBox="0 0 1024 1024" version="1.1"
                   xmlns="http://www.w3.org/2000/svg" p-id="3158" width="200" height="200">
                <path
            ...
            <a class="channel-link__right" href="//www.bilibili.com/blackboard/activity-list.html?"
               style="letter-spacing:2px;" target="_blank">
              <svg t="1642646844599" class="icon side-icon" viewBox="0 0 1024 1024" version="1.1"
            ...
            <a class="channel-link__right" href="//www.bilibili.com/cheese/?csource=common_hp_channelclass_icon"
               style="letter-spacing:2px;" target="_blank">
              <svg t="1642669966795" class="icon side-icon" viewBox="0 0 1024 1024" version="1.1"
            ...
            <a class="channel-link__right" href="https://www.bilibili.com/blackboard/activity-5zJxM3spoS.html"
               style="letter-spacing:0px;" target="_blank">
              <svg t="1642670011510" class="icon side-icon" viewBox="0 0 1024 1024" version="1.1"
                   xmlns="http://www.w3.org/2000/svg" p-id="3116" width="200" height="200">
                <path
            ...
            <a class="channel-link__right" href="//www.bilibili.com/v/musicplus/" style="letter-spacing:0px;"
               target="_blank">
              <svg t="1642669999866" class="icon side-icon" viewBox="0 0 1024 1024" version="1.1"
                   xmlns="http://www.w3.org/2000/svg" p-id="2989" width="200" height="200">
                <path
