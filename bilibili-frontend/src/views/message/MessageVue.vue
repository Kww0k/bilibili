...
onMounted(() => {
  request.get("/file/web/file/getFileById/" + 104).then((res : any) => {
...
<div style="width: 100%; height: 100%">
  ...
  <div style="width: 100%; height: calc(100vh - 64px);
    background-size: cover;background-repeat: no-repeat;background-position: center;"
       :style="{ background: `url(${url1}) top/cover no-repeat fixed` }">
      <div style="height: 100%; width: 1143px; margin: auto; display: flex">
        <div class="main-left">
          <div class="side-bar">
...
.item:before {
  ...
  border-radius: 50%;
  transform: translateY(-50%); /* 将点垂直居中 */
}
.item:hover {
